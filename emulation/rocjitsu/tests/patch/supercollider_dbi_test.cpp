...
TEST(SuperColliderDbi, CombinedCheckTrapCanPatchNativeLdsAndFlatInSameCodeObject) {
  ...
  EXPECT_EQ(result.patches[0].kind, SuperColliderDbiPatchKind::InlineLdsStoreCheckTrap);
